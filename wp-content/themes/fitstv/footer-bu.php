    ...
    <div class="news_letter">
      <label>Subscribe to Our Monthly Newsletter</label>
        <div class="input-group">
           ...
           <input type="text" id="subscribe-email" class="form-control input-lg" placeholder="Enter your email adress here">
           <button id="btn-subscribe" type="button" class="btn btn-primary">SUBSCRIBE</button>
