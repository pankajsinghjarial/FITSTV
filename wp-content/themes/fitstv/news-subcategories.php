		...
		<?php foreach($subCategories as $subCategory){ ?>
			<div class="full-w gymsAround">
				...
				<section class="sortColumn">
					<span>Sort By:</span>
					<select id="sort-<?php echo $subCategory->slug;?>" data-category="<?php echo $subCategory->slug;?>" data-type="sub-category">
			...
			<div class="news_slider_info data-<?php echo $subCategory->slug;?>" >
				<?php
				$args = array( 
						'posts_per_page' => 4, 
						'post_type' => 'news',
			...
			<div class="clear"></div>
			<div class="<?php echo $subCategory->slug;?>-loadMore loadMore displayNone"><img alt="load more" src="<?php echo get_template_directory_uri();?>/images/loader.gif"></div>
			<?php if($page < $totalPage){ ?>
				<center><button id="<?php echo $subCategory->slug;?>-loadmore" data-type="sub-category" class="loadmore" data-category="<?php echo $subCategory->slug;?>" class="btn btn-default">Load More</button></center>
			<?php } ?>
		<?php } ?>
...
?>
	...
	<?php if($page < $totalPage){ ?>
		<center><button id="<?php echo $category;?>-loadmore" data-type="category" class="loadmore" data-category="<?php echo $category;?>" class="btn btn-default">Load More</button></center>
	<?php } ?>
<?php
